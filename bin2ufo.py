...
def main(args=None):
    ...
    st_14_info = make_attr_dict("Seattle Transit", 14, 8)
    seattle_transit_14 = load_from_txt("seattle_transit_14")
    st_14_ufo = create_ufo("seattle_transit_dot_matrix_14", "out", seattle_transit_14, options.format, st_14_info)
    ...
    make_woff2(["out/seattle_transit_dot_matrix_14.otf"], "out")
